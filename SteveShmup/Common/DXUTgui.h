...
public:
    ...
    void Init( CDXUTDialogResourceManager* pManager, bool bRegisterDialog = true, LPCWSTR pszControlTextureFilename = L"UI\\DXUTControls.dds" );
...
private:
    ...
    void InitDefaultElements( LPCWSTR pszControlTextureFilename );
    void InitDefaultElements( LPCWSTR pszControlTextureResourceName, HMODULE hControlTextureResourceModule );
